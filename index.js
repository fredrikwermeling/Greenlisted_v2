...
var _testSequences = {
    human: "GAGCGCTGCTCAGATAGCGA\nGAAGGTGCGTTCGATGACAG\nGATGTACCTATGGTCCTAGT\nGAACTTCTGTACTACAACGC\nTCATCTGGATTATAGACCAG\nGAAGGGTGTGACCGCAACGT",
    mouse: "GCAGCGTTACCTCTATCGTA\nGAAGTCACAGCACATGACGG\nGGCAGGAAGACTCTAACGAT\nGCAATATGGATACTATCCAG\nTACTTCCTCCTCAAGAACGA"
    // Human: TP53(Brunello+GeCKO+Jacquere), AKT1(Brunello+VBC+TKOv3+MinLibCas9), KRAS(Brunello+GeCKO+Jacquere), BRAF(Jacquere+VBC+TKOv3), PTEN(Gattinara+Jacquere+TKOv3), MYC(Gattinara+VBC+TKOv3)
    // Mouse: Kras(Brie+Julianna+VBC+mTKO), Trp53(Brie+VBC+mTKO), Braf(Brie+Julianna+mTKO), Egfr(Julianna+VBC+mTKO), Akt1(Brie+GeCKO+mTKO)
}
