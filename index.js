...
var _testSequences = {
    human: "CCATTGTTCAATATCGTCCG\nTCTCGACACAGCAGGTCAAG\nCAAAGCAGAAACTCACATCG\nAGCCGCTCCACATACAGTCC\nGCCCAACAAACAGAGGACAG\nAGCGGGGACTCCCGAGACC\nACCGCCAAATTTAATTGCAG\nGGACTTCCAGCTACGGCGCG",
    mouse: "AACAGATCGTCCATGCAGTG\nTGAGTATGACCCTACGATAG\nGTCTTCAAGGATGTGAAGTG\nAACCGCTCCACATACAGTCC\nGCCCAACAAACAGAGGACAG\nGCACCTATTATTGTCTCCG\nACACCTTCAAGTCTTTCTGC"
    // Human test: TP53(Brunello), KRAS(GeCKO), EGFR(Gattinara), MYC(Jacquere), BRAF(VBC), CD19(Yusa), PTEN(TKOv3), A1BG(MinLibCas9)
    // Mouse test: Trp53(Brie), Kras(GeCKO), Egfr(Gouda), Myc(Julianna), Braf(VBC), Cd19(Yusa), Pten(mTKO)
}
